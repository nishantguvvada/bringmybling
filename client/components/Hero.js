            ...
            <div className="mt-10 mb-10 w-screen">   
                <div className="flex flex-row justify-center items-center max-w-screen-xl px-12 mx-auto lg:gap-8 xl:gap-0 ">
                    <div className="p-4 flex flex-col justify-center items-center max-w-[600px]">
                        ...
                        <p className="bg-white bg-opacity-70 p-4 rounded-lg max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Connect with travelers from your city heading to Dubai and get your favorite luxury items delivered without the hassle of shipping costs.</p>                   
                        ...
                        <blockquote className="bg-white bg-opacity-70 p-4 rounded-lg mt-8 mb-8 text-xl text-center italic font-semibold text-gray-900">
